...
import com.buzzer.config.AppConfig;
import com.buzzer.controller.IOManager;
import com.buzzer.controller.eventhandler.MenuHandler;
...
public class AppTray {
	...
	private void loadTrayIcon() {
		...
		try {
			...
			System.out
					.println("Error in reading Icon File! System abnormal end!");
			System.exit(1);
		}
	...
	private void loadEventHandlers() {
		/*
		 * The menu items in the system tray are initialized, the corresponding
		 * handlers are also created.
		 */
	...
	public AppTray() throws IOException {
		/*
		 * If SystemTray is not supported, then the application will not be
		 * initialized!
		 */
		init();
	}
