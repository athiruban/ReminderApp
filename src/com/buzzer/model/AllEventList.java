...
public class AllEventList extends EventList implements Serializable, Cloneable {
	/**
	...
	/*
	 * This method should have the right to create new Event object. Every time
	 * when we want to create new event we have to call this method.
	 * 
	 * @see athi.reminderapp.model.EventList#addNewEvent(java.lang.String,
	 * java.lang.String, java.lang.String)
	 */
	@Override
	public Event addNewEvent(String eventDesc, String eventDate,
			String eventTime) {
